...
def select_features(features, X_train_all, y_train_all):
    ...
    for j in reversed(range(1,51,1)):
        ...
        for f in features:
            for lr in learningrates:
                estimator = GradientBoostingClassifier(learning_rate = lr, random_state=random_state)
    ...
    estimator_select = GradientBoostingClassifier(learning_rate = lr, random_state=random_state)
...
pred_SMB.to_csv('GradientBoosting_SMB_30yr.csv')
pred_HML.to_csv('GradientBoosting_HML_30yr.csv')
test_acc_SMB.to_csv('GradientBoosting_SMB_acc_30yr.csv')
test_acc_HML.to_csv('GradientBoosting_HML_acc_30yr.csv')
...
pred_SMBHML.to_csv('GradientBoosting_SMBHML_30yr.csv')
test_acc_SMBHML.to_csv('GradientBoosting_SMBHML_acc_30yr.csv')
...
SMB_return.to_csv('GradientBoosting_SMB_return.csv')
HML_return.to_csv('GradientBoosting_HML_return.csv')
SMBHML_return.to_csv('GradientBoosting_SMBHML_return.csv')
